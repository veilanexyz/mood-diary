...
const Page2 = ({ assistant, onChangePage }) => {
  //  const navigate = useNavigate();
  useEffect(() => {
    const emotionsContainer = document.getElementsByClassName(
      'emotion-selector__checkbox'
    )[0];
  ...
  return (
    <div className="emotion-selector">
      ...
      <input
        className="emotion-selector__text-input text-input"
        type="text"
        name="feelings"
